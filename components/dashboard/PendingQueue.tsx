...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-6 text-center">
      ...
      <p className="text-xs font-medium text-zinc-600">All caught up</p>
      <p className="text-xs text-zinc-400 mt-0.5">No pending approvals</p>
    </div>
  )
}
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-3">
        <p className="text-xs font-semibold text-zinc-700">Pending approval</p>
