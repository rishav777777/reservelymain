...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center bg-white rounded-lg border border-zinc-200">
      ...
      <p className="text-sm font-medium text-zinc-700">No reservations today</p>
      <p className="text-xs text-zinc-400 mt-1">Reservations will appear here as they come in</p>
    </div>
  )
}
  ...
  return (
    <div className="space-y-5">
      {Object.entries(groups)
        ...
        .map(([hour, items]) => (
          <div key={hour}>
            <p className="text-xs font-medium text-zinc-400 mb-2 px-1 uppercase tracking-wider">
