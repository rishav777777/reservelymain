...
export const forRestaurantsT = {
  EN: {
    ...
    pricing: {
      ...
      perMonth:   'per month',
      tiers: [
        { name: 'Free',    price: '€0',  description: 'Start with no commitment.',        cta: 'Get started free',   features: ['Up to 50 bookings/month','Custom booking page','Email confirmations','Basic reservation calendar','1 staff account','GDPR-compliant'] },
        { name: 'Starter', price: '€29', description: 'For growing restaurants.',          cta: 'Start free trial',   features: ['Up to 250 bookings/month','3 staff accounts','Everything in Free, plus:','Guest CRM & Stammgast tracking','Analytics dashboard','Table plan editor','Walk-in management'] },
        { name: 'Pro',     price: '€49', description: 'The complete system for active restaurants.', cta: 'Start free trial', features: ['Up to 600 bookings/month','10 staff accounts','Everything in Starter, plus:','Stammtisch recurring reservations','Group bookings','Email & reminder automation','Advanced table blocking'] },
        { name: 'Growth',  price: '€59', description: 'No limits. For high-volume venues.',cta: 'Start free trial',   features: ['Unlimited bookings','Unlimited staff accounts','Everything in Pro, plus:','WhatsApp owner notifications','Advanced analytics & export','Audit log (full history)','Priority support'] },
      ],
    },
    faq: {
      eyebrow: 'FAQ',
      ...
      items: [
        { q: 'Is there a setup fee?',                  a: 'No. Reservely is free to start and there are no hidden fees. The Free plan is free forever; paid plans are billed monthly with no contracts.' },
        ...
        { q: 'Can I customise the booking form?',      a: 'On Starter and above you can add custom questions (e.g. allergy info, occasion) to the booking flow.' },
        { q: 'What happens if I exceed my plan limit?', a: "We'll notify you before you hit your monthly limit. You can upgrade at any time with one click — no bookings are ever lost." },
      ],
    },
    cta: {
  ...
  DE: {
    ...
    pricing: {
      ...
      perMonth:   'pro Monat',
      tiers: [
        { name: 'Free',    price: '€0',  description: 'Kostenlos starten, ohne Verpflichtung.',        cta: 'Kostenlos starten',       features: ['Bis zu 50 Buchungen/Monat','Individuelle Buchungsseite','E-Mail-Bestätigungen','Einfacher Reservierungskalender','1 Mitarbeiter-Account','DSGVO-konform'] },
        { name: 'Starter', price: '€29', description: 'Für wachsende Restaurants.',                    cta: 'Kostenlose Testversion',   features: ['Bis zu 250 Buchungen/Monat','3 Mitarbeiter-Accounts','Alles aus Free, plus:','Gäste-CRM & Stammgast-Tracking','Analytics-Dashboard','Tischplan-Editor','Walk-in-Verwaltung'] },
        { name: 'Pro',     price: '€49', description: 'Das komplette System für aktive Restaurants.',  cta: 'Kostenlose Testversion',   features: ['Bis zu 600 Buchungen/Monat','10 Mitarbeiter-Accounts','Alles aus Starter, plus:','Stammtisch-Reservierungen','Gruppenanfragen','E-Mail- & Erinnerungs-Automatisierung','Tisch-Sperrung & Wartungsmodus'] },
        { name: 'Growth',  price: '€59', description: 'Keine Limits. Für hochfrequentierte Locations.',cta: 'Kostenlose Testversion',   features: ['Unbegrenzte Buchungen','Unbegrenzte Mitarbeiter-Accounts','Alles aus Pro, plus:','WhatsApp-Benachrichtigungen','Erweiterte Analysen & Datenexport','Audit-Protokoll (vollständig)','Prioritäts-Support'] },
      ],
    },
    faq: {
      eyebrow: 'FAQ',
      ...
      items: [
        { q: 'Gibt es eine Einrichtungsgebühr?',                   a: 'Nein. Reservely ist kostenlos zu starten, es gibt keine versteckten Gebühren. Der Free-Plan ist dauerhaft kostenlos; kostenpflichtige Pläne werden monatlich ohne Vertrag abgerechnet.' },
        ...
        { q: 'Kann ich das Buchungsformular anpassen?',            a: 'Ab Starter können Sie dem Buchungsablauf benutzerdefinierte Fragen hinzufügen (z. B. Allergieinformationen, Anlass).' },
        { q: 'Was passiert, wenn ich mein Planlimit überschreite?', a: 'Wir benachrichtigen Sie, bevor Sie Ihr monatliches Limit erreichen. Sie können jederzeit mit einem Klick upgraden – keine Buchungen gehen verloren.' },
      ],
    },
    cta: {
